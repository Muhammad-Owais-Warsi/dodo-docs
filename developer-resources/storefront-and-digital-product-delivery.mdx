...
description: Utilise the power storefront and digital product delivery to sell and deliver products to your customers in no time.
icon: "credit-card"
---

## Overview
These two features allow you to setup a store for your customers and let you deliver digitial products in no time.
Below we'll setup a E-Book Store.
...
Setup the pricing details for your product.
...
Enter the discount applicable to the product/subscription.
...
Add key-value pairs as the metadat fields.
