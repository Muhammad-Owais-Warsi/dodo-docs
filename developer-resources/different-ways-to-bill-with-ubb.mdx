...
Select the Count aggregation to calculate the number of API calls.
...
<ParamField path="Aggregation Type" type="string" required>
Select how events should be aggregated:
Select the Sum aggregation to calculate token usage.
...
<ParamField path="Aggregation Type" type="string" required>
Select how events should be aggregated:
Select the Sum aggregation to calculate runtime.
