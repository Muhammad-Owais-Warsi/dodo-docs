...
In this section we'll see how the business can charge on the basis of the number of API calls made by their customers.
...
To calculate the number of API calls we'll go wtih `Count` type.
...
In this section we'll see how the business can charge on the basis of runtime by their customers.
...
<ParamField path="Aggregation Type" type="string" required>
Select how events should be aggregated:
To calculate the Runtime we'll go wtih `Sum` type.

</ParamField>

<ParamField path="Over Property" type="string">
The property name from event metadata to aggregate over. Here we aggregate it over `runtime` field.
...
In this section we'll see how the business can charge on the basis of Token usage by their customers.
...
<ParamField path="Aggregation Type" type="string" required>
Select how events should be aggregated:
To calculate the Token usage we'll go wtih `Sum` type.

</ParamField>

<ParamField path="Over Property" type="string">
The property name from event metadata to aggregate over. Here we aggregate it over `token_usage` field.
